...
$db['default']['hostname'] = '192.168.56.134';
$db['default']['username'] = 'root';
$db['default']['password'] = '';
$db['default']['database'] = 'sippai';
...
$db['default_test']['hostname'] = '192.168.56.134';
$db['default_test']['username'] = 'root';
$db['default_test']['password'] = '';
$db['default_test']['database'] = 'sippai_test';
$db['default_test']['dbdriver'] = 'mysql';
$db['default_test']['dbprefix'] = 'si_';
